...
<html lang="en">
  <head>
    ...
    <!-- Animate.css -->
    <link href="/user/vendors/animate.css/animate.min.css" rel="stylesheet">
        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form method="post" action="">
              ...
              <div>
                <button type="submit" class="btn btn-success btn-lg col-md-12 submit" >se connecter</button>
              ...
              <div class="separator">
                <p class="change_link">New to site?
                  <a href="/action/inscription" class="to_register"> Create Account </a>
                </p>
                ...
                <div>
                  <h1><i class="fa fa-home"></i> E-trading  212</h1>
