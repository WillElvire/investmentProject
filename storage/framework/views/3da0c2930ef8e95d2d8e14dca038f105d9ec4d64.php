	          ...
	          <div class="row no-gutters slider-text align-items-center justify-content-center">
		          <div class="col-md-8 ftco-animate">
		          	<div class="text w-100 text-center">
		          		<h2><?php echo e(__('we business grow')); ?></h2>
						<h1 class="mb-4"><?php echo e(__('We Help You Businesses Innovate and Grow')); ?></h1>
						
						<p>
							<a href="#" class=" col-md- 6 btn btn-white"><?php echo e(__('Connect with us')); ?></a>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-secondary">
      <div class="container py-5">
          ...
          <div class="col-md-5 d-flex align-items-center">
            <form method="POST" action="<?php echo e(route('newletter.path')); ?>" class="subscribe-form">
              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nagninimeta/Documents/PROJET/laravel/investmentProject/resources/views/layout/home.blade.php ENDPATH**/ ?>